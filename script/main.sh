...
cd $home/build; ./main -acc -strategy PPCU -type GPU -port 8080 -peers "localhost:32768,1.0" -d $file -ncol $ncol -ps 10000 -g 50 -nb 80; cd -

reset; cd build; make; ./main -acc -strategy PPCU -type GPU -port 8080 -peers "localhost:32768,1.0" -d /home/amanda/Documentos/problema-01_pee/generate/file_10x1000 -ncol 10 -ps 1000 -g 50 -nb 80; cd -
