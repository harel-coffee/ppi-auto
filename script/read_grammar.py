               ...
               if list(grammar[ini])[0] == "<" and list(grammar[ini])[-1] == ">":
                  ...
                  if grammar[ini] in ['+', '-', '*', '/', '<', '<=', '>', '>=', '=', '!=']:
                     ...
                     if "ATTR" in  grammar[ini].upper():
                        if grammar[ini][4:].upper() not in text6:
                           text6.append(grammar[ini][4:].upper())
                     else:
                        if not text5:
                  ...
                  if list(grammar[j])[0] == "<" and list(grammar[j])[-1] == ">":
                     ...
                     if grammar[j] in ['+', '-', '*', '/', '<', '<=', '>', '>=', '=', '!=']:
                        ...
                        if "ATTR" in  grammar[j].upper():
                           if grammar[j][4:].upper() not in text6:
                              text6.append(grammar[j][4:].upper())
                        else:
                           if not text5:
...
text6.sort()
text6 = map(str,text6)
text6 = [', T_ATTR' + s for s in text6]
text6[0] = text6[0] + ' = ATTRIBUTE_MIN'
text6 = [', T_ATTRIBUTE'] + text6
text6 = ''.join(text6)
